     ...
     Program PHONON v.6.0 (svn rev. 13079) starts on 30Jul2020 at  0:45:54 
   ...
   Info: using nr1, nr2, nr3 values from input
     ...
     Pert. #  3: Fermi energy shift (Ry) =    -8.0995E-25    -4.6530E-39
      ...
      iter #   2 total cpu time :     6.2 secs   av.it.:   9.8
     ...
     Pert. #  3: Fermi energy shift (Ry) =     2.3437E-24    -8.5713E-40
      ...
      iter #   3 total cpu time :     7.0 secs   av.it.:  10.2
     ...
     Pert. #  3: Fermi energy shift (Ry) =    -4.4806E-25     5.5101E-40
      ...
      iter #   4 total cpu time :     9.5 secs   av.it.:   9.7
     ...
     Pert. #  3: Fermi energy shift (Ry) =    -1.2063E-24     6.1224E-41
      ...
      iter #   5 total cpu time :    12.6 secs   av.it.:  10.5
     ...
     Pert. #  3: Fermi energy shift (Ry) =    -9.3058E-25     6.1224E-41
      ...
      iter #   6 total cpu time :    13.4 secs   av.it.:   9.4
 ...
 **************************************************************************
   ...
   Cartesian axes
    ...
    26.5319  34.4640
     ...
     Alpha used in Ewald sum =   2.0000
     PHONON       :  0m46.96s CPU     1m 8.78s WALL
 ...
 **************************************************************************
   ...
   Cartesian axes
     ...
     Alpha used in Ewald sum =   2.0000
     PHONON       :  1m 9.03s CPU     1m39.28s WALL
 ...
 **************************************************************************
   ...
   Cartesian axes
     ...
     Alpha used in Ewald sum =   2.0000
     PHONON       :  1m59.13s CPU     2m44.61s WALL
 ...
 **************************************************************************
   ...
   Cartesian axes
    ...
    24.6609  38.3843
     ...
     Alpha used in Ewald sum =   2.0000
     PHONON       :  2m24.04s CPU     3m18.86s WALL
 ...
 **************************************************************************
   ...
   Cartesian axes
    ...
    30.6868  37.9219
     ...
     Alpha used in Ewald sum =   2.0000
     PHONON       :  2m37.15s CPU     3m39.86s WALL
 ...
 **************************************************************************
     ...
     electrons    :     14.27s CPU     15.11s WALL (       7 calls)

     Called by init_run:
     wfcinit      :      0.00s CPU      0.00s WALL (       7 calls)
     potinit      :      0.36s CPU      0.36s WALL (       7 calls)

     Called by electrons:
     c_bands      :     14.26s CPU     15.09s WALL (       7 calls)
     v_of_rho     :      0.01s CPU      0.01s WALL (       8 calls)
     newd         :      0.01s CPU      0.01s WALL (       8 calls)
     PAW_pot      :      0.39s CPU      0.40s WALL (       8 calls)

     Called by c_bands:
     init_us_2    :      0.26s CPU      0.26s WALL (   12582 calls)
     cegterg      :     10.80s CPU     11.19s WALL (     818 calls)

     Called by sum_band:

     Called by *egterg:
     h_psi        :     58.79s CPU     61.97s WALL (  132918 calls)
     s_psi        :      2.66s CPU      2.60s WALL (  263216 calls)
     g_psi        :      0.03s CPU      0.04s WALL (   11498 calls)
     cdiaghg      :      3.53s CPU      3.50s WALL (   12314 calls)

     Called by h_psi:
     h_psi:pot    :     58.55s CPU     61.61s WALL (  132918 calls)
     h_psi:calbec :      3.24s CPU      3.49s WALL (  132918 calls)
     vloc_psi     :     53.51s CPU     56.14s WALL (  132918 calls)
     add_vuspsi   :      1.40s CPU      1.40s WALL (  132918 calls)

     General routines
     calbec       :      8.68s CPU      9.16s WALL (  285976 calls)
     fft          :      0.17s CPU      0.18s WALL (    3097 calls)
     ffts         :      0.04s CPU      0.06s WALL (    1438 calls)
     fftw         :     92.14s CPU     94.90s WALL ( 1613093 calls)
     davcio       :      0.73s CPU     26.93s WALL (   54301 calls)
 
     Parallel routines
     fft_scatter  :     68.59s CPU     70.69s WALL ( 1617628 calls)
 
     PHONON       :  2m52.13s CPU     4m 1.32s WALL

     INITIALIZATION: 
     phq_setup    :      0.04s CPU      0.05s WALL (       8 calls)
     phq_init     :      1.41s CPU      4.91s WALL (       8 calls)
     ...
     drho         :      0.84s CPU      1.18s WALL (       8 calls)
 
     DYNAMICAL MATRIX:
     dynmat0      :      0.34s CPU      3.48s WALL (       8 calls)
     phqscf       :    153.02s CPU    212.33s WALL (       8 calls)
     dynmatrix    :      0.21s CPU      0.23s WALL (       8 calls)
 
     phqscf       :    153.02s CPU    212.33s WALL (       8 calls)
     solve_linter :    149.95s CPU    208.88s WALL (      17 calls)
     drhodv       :      3.03s CPU      3.39s WALL (      17 calls)
 
     dynmat0      :      0.34s CPU      3.48s WALL (       8 calls)
     dynmat_us    :      0.18s CPU      0.19s WALL (       8 calls)
     ...
     solve_linter :    149.95s CPU    208.88s WALL (      17 calls)
     dvqpsi_us    :      1.46s CPU      1.58s WALL (    1272 calls)
     ortho        :      1.26s CPU      1.28s WALL (   10512 calls)
     cgsolve      :     64.07s CPU     67.49s WALL (   10512 calls)
     incdrhoscf   :     24.40s CPU     24.89s WALL (   10512 calls)
     addusddens   :      0.29s CPU      0.36s WALL (     156 calls)
     vpsifft      :     16.67s CPU     16.98s WALL (    9240 calls)
     dv_of_drho   :      0.08s CPU      0.09s WALL (     182 calls)
     mix_pot      :      5.97s CPU     36.47s WALL (     139 calls)
     ef_shift     :      0.05s CPU      0.05s WALL (       7 calls)
     localdos     :      0.01s CPU      0.01s WALL (       1 calls)
     psymdvscf    :      1.22s CPU      1.23s WALL (     139 calls)
     newdq        :      0.31s CPU      0.32s WALL (     139 calls)
     adddvscf     :      0.19s CPU      0.23s WALL (    9240 calls)
     drhodvus     :      0.05s CPU      0.05s WALL (      17 calls)
 
     dvqpsi_us    :      1.46s CPU      1.58s WALL (    1272 calls)
     dvqpsi_us_on :      0.52s CPU      0.55s WALL (    1272 calls)
 
     cgsolve      :     64.07s CPU     67.49s WALL (   10512 calls)
     ch_psi       :     60.41s CPU     63.83s WALL (  119786 calls)
 
     ch_psi       :     60.41s CPU     63.83s WALL (  119786 calls)
     last         :      6.13s CPU      6.51s WALL (  119786 calls)
 
     add_vuspsi   :      1.40s CPU      1.40s WALL (  132918 calls)
 
     incdrhoscf   :     24.40s CPU     24.89s WALL (   10512 calls)
     addusdbec    :      0.39s CPU      0.42s WALL (   11784 calls)
     ...
     fftw         :     92.14s CPU     94.90s WALL ( 1613093 calls)
     davcio       :      0.73s CPU     26.93s WALL (   54301 calls)
     write_rec    :      0.24s CPU     17.95s WALL (     156 calls)
 
 
     PHONON       :  2m52.13s CPU     4m 1.32s WALL

 
   This run was terminated on:   0:49:55  30Jul2020            
